...
/**
 * Database varchar schema column.
 */
class ColVarChar extends Col implements ColInterface
{
    /**
     * Constructor.
     *
     ...
     * @return  void
     */
    public function __construct(TableInterface $table, string $name, int $length = 255, ?string $default = '', array $props = array())
    {
