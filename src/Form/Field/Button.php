...
class Button extends Field
{
     ...
     * @var int
     */
    protected $valueType = self::VALUE_IS_DATA;
     ...
     * @return  void
     */
    public function __construct(FormInterface $form, array $params = [], bool $autoLabel = false, bool $allowAutoWrap = true)
    {
        parent::__construct($form, 'button', $params, $autoLabel, $allowAutoWrap);
    }
